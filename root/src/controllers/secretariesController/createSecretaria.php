...
try{
    ...
    $sentenciaInsertarAdministrative = $database->prepare("INSERT INTO Secretaria(nombre, apellido, id_rol, tipo_documento, numero_documento, telefono, email, direccion, contraseña) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?);");
