            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-header text-center">
                        <h4>Registro Administrativos</h4>
                    </div>
                    <div class="card-body">
                        <form method="post" action="/HealthConnection/root/src/controllers/administrativeController/createAdministrativo.php" enctype="multipart/form-data">
