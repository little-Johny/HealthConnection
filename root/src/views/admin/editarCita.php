...
<body class="bg-body-secondary">
    ...
    <main class="edit-container">
        <section id="edit">
            <h2>Edita</h2>
            <form action="<?php echo $baseUrlSrc;?>controllers/updateCitas.php" method="post" enctype="multipart/form-data">
                ...
                <div class="buttons">
                    ...
                    <button type="button" class="btn btn-secondary" onclick="window.location.href='./historialSolicitudes.html'">Cancelar</button>
                </div>
            </form>
        </section>
    </main>
